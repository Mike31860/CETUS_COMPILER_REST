...
CETUSROOT=$PWD
SRC="$CETUSROOT/src/main/java/com/example/demo/cetus/*/*/*.java $CETUSROOT/src/main/java/com/example/demo/cetus/*/*/*/*.java"
PARSER="$CETUSROOT/src/main/java/com/example/demo/cetus/base/grammars"
