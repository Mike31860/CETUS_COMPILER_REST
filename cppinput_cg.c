...
#pragma startinclude #include <papi.h>
#line 47
#include <papi.h>
#pragma endinclude
#line 48
#pragma startinclude #include <stdint.h>
#line 48
#include <stdint.h>
#pragma endinclude
#line 49
...
int main(int argc, char *argv[])
{
  ...
  if ((fp = fopen("timer.flag", "r")) != NULL) {
    ...
    t_names[T_sparse] = "sparse";
    t_names[TimeInstrument_Tuning_section_sparse_S0] = "TimeInstrument_Tuning_section_sparse_S0";
    t_names[TimeInstrument_Tuning_section_conj_grad_S1] = "TimeInstrument_Tuning_section_conj_grad_S1";
    t_names[TimeInstrument_Tuning_section_conj_grad_S2] = "TimeInstrument_Tuning_section_conj_grad_S2";
    t_names[TimeInstrument_Tuning_section_conj_grad_S3] = "TimeInstrument_Tuning_section_conj_grad_S3";
    t_names[TimeInstrument_Tuning_section_conj_grad_S4] = "TimeInstrument_Tuning_section_conj_grad_S4";
    fclose(fp);
  } else {
    timeron = false;
  }
  ...
  if (timeron) {
    ...
    for (i = 0; i < T_last; i++) {
      ...
      if (i == T_init) {
        ...
        else if (i == TimeInstrument_Tuning_section_sparse_S0) {
          //t = tmax - t;
          printf("  %8s = %9.3f  \n", t_names[i], t/numberIterations);
